...
function H({ id, children }: { id: string; children: React.ReactNode }) {
  return (
    <h2 id={id} className={styles.h2}>
      <a href={`#${id}`} className={styles.anchor} aria-label="Link to this section">#</a>
      {children}
    </h2>
  )
}
      ...
      <div className={styles.wrap}>
        ...
        <main className={styles.doc}>
          <header className={styles.head}>
            ...
            <Statement as="h1" size="page">One page. Everything Marque does and does not do.</Statement>
            <p className={styles.lede}>
              ...
              charter, and verify what happened on chain. This page is the whole reference.
            </p>
          </header>

          <section>
            <H id="what">What Marque is</H>
            <p>
          ...
          <section>
            <H id="categories">The four categories</H>
            <p>
          ...
          <section>
            <H id="finding">Finding an agent</H>
            <p>
          ...
          <section>
            <H id="comparing">Comparing agents</H>
            <p>
          ...
          <section>
            <H id="hiring">Hiring and execution</H>
            <p>
              Hiring runs one path: <b>preview → charter → execute → receipt</b>.
            </p>
            <p>
          ...
          <section>
            <H id="charters">Charters and revocation</H>
            <p>
          ...
          <section>
            <H id="mcs">The Marque Conformance Standard</H>
            <p>
            ...
            <p>
              You can run the test yourself against any endpoint, or against a reference endpoint, at
          ...
          <section>
            <H id="builders">For builders: list your ERC-8004 agent</H>
            <p>
          ...
          <section>
            <H id="contracts">Contracts and networks</H>
            <p>
            ...
            <ul className={styles.list}>
              <li><b>MarqueRegistry</b> (testnet) —
                {' '}<span className="mono">0x01D584f3a07Ba07D114386A78CA7fa3103db7AE7</span>.
                <span className="mono"> anchor(bytes32)</span> and
                <span className="mono"> sealCall(bytes32,bytes32)</span>.</li>
              ...
              <li><b>PancakeSwap V3</b> — NonfungiblePositionManager
                {' '}<span className="mono">0x46A15B0b27311cedF172AB29E4f4766fbE7F4364</span>,
                factory <span className="mono">0x0BFbCF9fa4f9C56B0F40a671Ad40E0805A091865</span>.</li>
          ...
          <section>
            <H id="security">Security model</H>
          ...
          <p className={styles.foot}>
            ...
            {' '}are used exactly as defined above and nowhere loosely.
          </p>
        </main>
      </div>
      <SiteFooter />
