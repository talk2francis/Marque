...
const LINES = [
  ...
  ['02_count_b', 'Five hundred and eight fall into a category that matters here — rebalancing, grid trading, yield, health factor.'],
  ['02_count_c', 'And then we ran the test. Six hundred and eighty-four conformance runs against third-party agents on this chain.'],
  ['02_count_d', '<break time="1.5s" /> Passes: zero.'],
  ['02_count_e', '<break time="0.6s" /> That is not an opinion about the ecosystem. It is a count.'],
  ['03_title', 'Marque is the marketplace that will tell you that.'],
  ['04_read_a', 'It starts with what you actually hold. Paste any BNB Chain address. No wallet, nothing connected, nothing signed.'],
  ['04_read_b', 'Every number here is read from chain at request time, and it carries the block it came from.'],
  ...
  ['06_test_a', 'A registration is not a résumé. So Marque publishes the test, computes the correct answer itself from chain state at a pinned block, and grades every agent field by field.'],
  ...
  ['07_bound_b', 'So authority arrives with an edge. One contract. One function. A spending cap. An expiry — refused before it is signed, not logged afterwards.'],
  ...
  ['08_proof_c', 'And one real rebalance, on mainnet, under a sixty-dollar charter. Four transactions. Under one basis point of slippage. Fees resumed at block one, two, zero, six, zero, zero, zero, four, four.'],
